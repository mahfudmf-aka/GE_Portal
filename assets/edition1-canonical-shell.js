...
function nav(){return [
 ...
 group('IMPROVEMENT & PLANNING',[item('e1-inisiatif.html','Initiative & Improvement','initiative'),item('improvement-intake.html','Improvement Opportunity','opportunity'),item('e1-calendar.html','Calendar & Project Tracking','calendar'),item('e1-service-planning.html','Planning Overview','standard'),item('planning-workspace.html','Planning Workspace','document'),item('e1-lounge-list.html','Lounge / Tenant Planning','data'),item('e1-branch-office-planning.html','Branch Office Planning','station'),item('e1-gaso-planning.html','GASO Planning','station'),item('e1-planning-documents.html','Planning Documents','document')]),
