...
assert(app.includes('v=r12'),'Canonical root assets must use current cache identity.');
assert(registry.includes('edition1-business-runtime.js?v=r12'),'Canonical page runtime must use current cache identity.');
