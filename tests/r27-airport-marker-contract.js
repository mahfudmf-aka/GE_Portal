...
ok(rt.includes('geAirportInfoR27'),'R27 canonical visible-row airport lookup missing');
ok(rt.includes('mapProviderTypeR27')&&rt.includes('Ground Handling Agent'),'provider type filter missing');
